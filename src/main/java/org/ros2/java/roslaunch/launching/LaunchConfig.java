...
import org.ros2.java.roslaunch.parsing.RosParamTag;
...
//		launchFiles.add(m_rosCoreLaunch);
		...
		RosParamManager.deleteParameters(m_rosParams, "");

		// Execute all dump rosparams next
		RosParamManager.dumpParameters(m_rosParams, "");
...
//		ClearParamsManager.clearParams(m_unifiedClearParams, m_uri);
		...
		RosParamManager.setParameters(m_rosParams, "");

		// Set all of the standard params
		ParamManager.setParameters(m_params, "");
	}
